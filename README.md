# DRPI-DEIM
# Description
We propose a novel lightweight object detection algorithms, using DEIM, specifically for autonomous underwater vehicles to detect marine debris.
# **Experimental** **setup**
...
- These experiments utilized datasets including: Trash-ICRA19, TrashCan, UDD.
- This model includes the design of attention in the backbone of the DEIM model, the design of the encoder structure, and the improvement of the feature extraction module, and proposes a progressive wavelet transform enhancement module for solving image degradation problems. 
